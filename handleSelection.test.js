...
describe("Test handleSelection function", () => {
    ...
    test("test add function", () => {
        ...
        expect(result).toEqual({printMsg: "apple was added successfuly !!\n", terminate:false});
    });
    test("test add function", () => {
        const result = handleSelection(root, "add apricote");

        expect(result).toEqual({printMsg: "apricote was added successfuly !!\n", terminate:false});
    });
    test("test add function", () => {
        const result = handleSelection(root, "add 3edfr");

        expect(result).toEqual({printMsg: "Please use alphabet only\n", terminate:false});
    });
